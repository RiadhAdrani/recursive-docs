...
import { text_color, text_color_2 } from "../../style/colors";
...
const Icon = ({ path, size = "20px" }) => {
    return Svg({
        ...
        style: {
            scoped: true,
            normal: {
                fill: getVar(text_color),
            },
            hover: {
                fill: getVar(text_color_2),
            },
        },
