...
import getAnchorDoc from "./md/getAnchor.md";
import isWithinRouteDoc from "./md/isWithinRoute.md";
...
const RoutingMethods = [
  ...
  section({ title: "getAnchor()", path: "/getAnchor", doc: getAnchorDoc }),
  section({ title: "isWithinRoute()", path: "/isWithinRoute", doc: isWithinRouteDoc }),
